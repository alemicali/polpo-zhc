...
Uses `@openpolpo/react-sdk` hooks (`useTasks`, `useAgents`, `usePlans`, etc.) backed by SSE for push-based real-time updates. All data is read-only — the UI reflects the orchestrator's actual state.
