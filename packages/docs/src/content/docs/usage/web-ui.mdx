---
title: Web UI
description: Next.js dashboard for Orchestra
---

import { Steps, Aside } from '@astrojs/starlight/components';

Orchestra includes a modern web dashboard built with Next.js 15 and shadcn/ui.
...
Agent management:
- **Agent list**: All registered agents with adapter and role info
...
- **Monospace editor**: Full-featured text editor for `.orchestra/memory.md`
...
The web UI is built on the `@orchestra/react` SDK, which provides type-safe hooks:
...
See [React SDK Reference](/reference/react-sdk/) for full documentation.
...
| UI Library | shadcn/ui (zinc dark theme) |
| State | `@orchestra/react` SDK (SSE + `useSyncExternalStore`) |
| Icons | Lucide React |
| Toasts | Sonner |
