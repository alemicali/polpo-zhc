...
import 'no_workers_services_list_model.dart';
export 'no_workers_services_list_model.dart';

class NoWorkersServicesListWidget extends StatefulWidget {
  const NoWorkersServicesListWidget({
    super.key,
  ...
  @override
  State<NoWorkersServicesListWidget> createState() =>
      _NoWorkersServicesListWidgetState();
}

class _NoWorkersServicesListWidgetState
    extends State<NoWorkersServicesListWidget> {
  late NoWorkersServicesListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoWorkersServicesListModel());
