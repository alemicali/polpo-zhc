              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(12.0, 36.0, 0.0, 0.0),
                      child: Material(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            FFAppState().selectedAccomodation.accommodationName,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                if (widget.currentItem == 'dashboard') {
                                  return Container(
                                    width:
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                if (widget.currentItem == 'bookings_agenda') {
                                  return Container(
                                    width:
                                        MediaQuery.sizeOf(context).width * 1.0,
                                    decoration: BoxDecoration(
                              ...
                              builder: (context) {
                                if (widget.currentItem == 'clients') {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed(ClientsWidget.routeName);
                                    },
                                    child: Container(
                                      width: MediaQuery.sizeOf(context).width *
                                          1.0,
