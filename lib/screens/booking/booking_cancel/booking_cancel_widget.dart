...
import 'booking_cancel_model.dart';
export 'booking_cancel_model.dart';
...
class BookingCancelWidget extends StatefulWidget {
  ...
  static String routeName = 'Booking_cancel';
  static String routePath = '/bookingCancel';
...
class _BookingCancelWidgetState extends State<BookingCancelWidget> {
  late BookingCancelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingCancelModel());
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'pbiqirml' /* Riepilogo appuntamento */,
                                                                  ),
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'w5wzvhez' /* Chi ha causato l'annullamento? */,
                                                    ),
                                                        ...
                                                        child:
                                                          ...
                                                          options: [
                                                            ...
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '4u26nwxv' /* Operatore BF Wellness */,
                                                            )
                                                          ].toList(),
                                                          onChanged: (val) =>
                                                              safeSetState(
                                                          ...
                                                          decoration:
                                                            ...
                                                            labelText:
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                              '0e6tab66' /* Motivo dell'annullamento */,
                                                            ),
                                                            labelStyle:
                                                                FlutterFlowTheme.of(
                                                                        context)
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            ...
                                                            await widget
                                                              ...
                                                              ...mapToFirestore(
                                                                {
                                                                  'toPay': FieldValue.increment(-(widget
                                                                      .appointment!
                                                                      .serviceData
                                                                      .price)),
                                                                },
