...
import 'booking_reschedule_operators_selection_model.dart';
export 'booking_reschedule_operators_selection_model.dart';

class BookingRescheduleOperatorsSelectionWidget extends StatefulWidget {
  const BookingRescheduleOperatorsSelectionWidget({
    super.key,
  ...
  static String routeName = 'Booking_reschedule_operators_selection';
  static String routePath = '/bookingRescheduleOperatorsSelection';

  @override
  State<BookingRescheduleOperatorsSelectionWidget> createState() =>
      _BookingRescheduleOperatorsSelectionWidgetState();
}

class _BookingRescheduleOperatorsSelectionWidgetState
    extends State<BookingRescheduleOperatorsSelectionWidget> {
  late BookingRescheduleOperatorsSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => BookingRescheduleOperatorsSelectionModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'Booking_reschedule_operators_selection',
