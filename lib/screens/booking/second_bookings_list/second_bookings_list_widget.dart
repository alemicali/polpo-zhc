...
import 'second_bookings_list_model.dart';
export 'second_bookings_list_model.dart';

class SecondBookingsListWidget extends StatefulWidget {
  const SecondBookingsListWidget({
    super.key,
    this.startDate,
  });
  ...
  static String routeName = 'Second_bookings_list';
  static String routePath = '/second_bookings_list';

  @override
  State<SecondBookingsListWidget> createState() =>
      _SecondBookingsListWidgetState();
}

class _SecondBookingsListWidgetState extends State<SecondBookingsListWidget>
    with TickerProviderStateMixin {
  late SecondBookingsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecondBookingsListModel());
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final upcomingWorkersData =
                                                                                listViewAppointmentsRecord.workersData.toList();
