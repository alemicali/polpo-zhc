...
import '/components/empty_clients/empty_clients_widget.dart';
...
import 'booking_client_selection_model.dart';
export 'booking_client_selection_model.dart';

class BookingClientSelectionWidget extends StatefulWidget {
  const BookingClientSelectionWidget({
    super.key,
    this.date,
    this.time,
    this.operator,
  ...
  static String routeName = 'Booking_client_selection';
  static String routePath = '/bookingClientSelection';

  @override
  State<BookingClientSelectionWidget> createState() =>
      _BookingClientSelectionWidgetState();
}

class _BookingClientSelectionWidgetState
    extends State<BookingClientSelectionWidget> {
  late BookingClientSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingClientSelectionModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'Booking_client_selection',
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'hz627u4k' /* Cerca o crea un cliente */,
                                                            ),
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                      ...
                                                                      context
                                                                        ...
                                                                        queryParameters:
                                                                          ...
                                                                          'serviceCategoryReference':
                                                                              serializeParam(
                                                                            widget.serviceCategoryReference,
