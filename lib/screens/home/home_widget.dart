                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'jdiqvkzv' /* Bentornato in BF Wellness */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodySmall
                                                          ...
                                                          Expanded(
                                                            child: StreamBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                List<ClientsRecord>
                                                                    toCollectAmountClientsRecordList =
                                                                    snapshot
                                                                        .data!;
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  child:
                                                                      wrapWithModel(
                                                                    model: _model
                                                                        .toCollectAmountModel,
                                                                    updateCallback: () =>
                                                                        safeSetState(
                                                                            () {}),
                                                                    child:
                                                                        ToCollectAmountWidget(
                                                                      toCollect:
                                                                          functions
                                                                              .clientsTotalToPay(toCollectAmountClientsRecordList.toList()),
                                                                    ),
                                                                  ),
                                                                );
                                                              },
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            highlightColor:
                                                                Colors
                                                                    .transparent,
                                                            onTap: () async {
                                                              _model.client = await ClientsRecord
                                                                  .getDocumentOnce(
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Builder(
                                                                            builder:
                                                                                (context) {
                                                                              final workersData = listViewAppointmentsRecord.workersData.toList();

                                                                              return Column(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                                children: List.generate(workersData.length, (workersDataIndex) {
                                                                                  final workersDataItem = workersData[workersDataIndex];
                                                                                  return Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 4.0),
                                                                                    child: Text(
                                                                                      workersDataItem.name,
                                                                                      textAlign: TextAlign.start,
