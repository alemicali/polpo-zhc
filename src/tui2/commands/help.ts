...
export const COMMANDS = [
  ...
  { command: "/missions", description: "Manage execution missions" },
  ...
  { command: "/template", description: "Discover and run mission templates" },
  { command: "/skills", description: "Manage agent skills" },
  { command: "/checkpoints", description: "List/resume mission checkpoints" },
