 ...
 */
export function showPicker(_host: WidgetHost, opts: PickerOptions): Promise<number> {
 ...
 */
export function showTextInput(_host: WidgetHost, opts: TextInputOptions): Promise<string | null> {
  return new Promise((resolve) => {
 ...
 */
export function showTextarea(_host: WidgetHost, opts: TextareaOptions): Promise<string | null> {
  return new Promise((resolve) => {
...
export function createOverlay(_host: WidgetHost): OverlayResult {
