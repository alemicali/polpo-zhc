...
export async function buildChatSystemPrompt(
  ...
  const parts: string[] = [
    ...
    `what's missing. If the user asks to REPLACE their config with a package, you should first remove`,
    `the conflicting agents/teams manually (via \`save_config\` or \`remove_agent\`), then call \`ink_add\`.`,
    ``,
