...
export function buildPlanSystemPrompt(
  ...
  return [
    ...
    ``,
    `name: "kebab-case-plan-name"       # 2-4 words describing the plan, e.g. "implement-auth-system", "refactor-database-layer"`,
    ``,
    ...
    `## Rules`,
    ``,
    `- Start with a \`name:\` field — a short kebab-case slug (2-4 words, max 30 chars) that describes the plan purpose`,
...
export function buildTaskPrepPrompt(
  ...
  return [
    ...
    `        threshold: 3.0                # adaptive: 2.5 (prototype) / 3.0 (feature) / 3.5 (refactor) / 4.0 (simple fix)`,
    `        dimensions:`,
    `          - name: dimension_name`,
    `            weight: 0.40`,
    `            description: "What this dimension measures for this task"`,
    `            rubric:`,
    `              1: "Completely fails to meet requirements"`,
    `              2: "Major gaps or issues"`,
    `              3: "Acceptable but with some issues"`,
    `              4: "Good quality, minor issues only"`,
    `              5: "Excellent, exceeds requirements"`,
    `          - name: another_dimension`,
    `            weight: 0.35`,
    `            description: "Another relevant quality aspect"`,
    `            rubric:`,
    `              1: "..."`,
    `              2: "..."`,
    `              3: "..."`,
    ...
    `            weight: 0.25`,
    `            description: "Third relevant quality aspect"`,
    `            rubric:`,
    `              1: "..."`,
    `              2: "..."`,
    `              3: "..."`,
    ...
    `- For llm_review, ALWAYS include task-specific dimensions (3-4) with weights summing to 1.0 and per-level rubrics`,
    `- For llm_review, ALWAYS set an adaptive threshold based on task complexity (2.5 / 3.0 / 3.5 / 4.0)`,
