...
export function buildChatSystemPrompt(
  ...
  const parts: string[] = [
    ...
    `## Your tools`,
    ``,
    `You have 56 tools organized into 13 categories. Use them. Don't describe what you would do — do it.`,
    ``,
    ...
    `and allowedTools wildcards: "browser_*", "email_*", "image_*", "video_*", "audio_*", "excel_*", "pdf_*", "docx_*", "search_*".`,
