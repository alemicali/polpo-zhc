...
export function buildChatSystemPrompt(
  ...
  const parts: string[] = [
    ...
    `## Mentions`,
    ``,
    `Users can reference agents, tasks, and missions with the \`@\` syntax:`,
    ...
    `When you see \`@name\` in a user message, resolve it against the current agents, tasks, and missions listed below.`,
    ``,
    `---`,
    ``,
