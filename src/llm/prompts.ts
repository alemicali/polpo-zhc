...
export function buildChatSystemPrompt(
  ...
  const parts: string[] = [
    ...
    `  tells you the new value directly in chat (e.g. "cambia la password SMTP di Marco a xyz123").`,
    `  "aggiorna la password gmail di Marco" → update_vault_credentials with agent="marco",`,
