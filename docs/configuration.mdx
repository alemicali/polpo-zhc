...
Agents support many additional options like `allowedTools` (include `"browser_*"` or `"email_*"` for extended tools), `allowedPaths`, `skills`, and more. See [Configuration Reference](/reference/config) for the full field list.
