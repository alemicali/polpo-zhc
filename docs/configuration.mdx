...
Agents support many additional options like `allowedTools` (include `"browser_*"`, `"email_*"`, `"vault_*"`, `"image_*"`, `"video_*"`, `"audio_*"`, or `"search_*"` for extended tools), `allowedPaths`, `skills`, and more. See [Configuration Reference](/reference/config) for the full field list.
