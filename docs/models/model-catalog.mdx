...
| **Budget** | `claude-haiku-4-5`, `gpt-4o-mini`, `gemini-2.5-flash`, `o4-mini` | $0.15 - $1 | $0.60 - $5 | High-volume simple tasks |
| **Standard** | `claude-sonnet-4-6`, `gpt-5.2`, `gpt-4o`, `gemini-2.5-pro` | $1.75 - $5 | $8 - $15 | General coding, daily work |
| **Premium** | `claude-opus-4-6`, `o3`, `grok-4` | $3 - $15 | $15 - $75 | Complex architecture, review |
