...
SQLite and PostgreSQL both use [Drizzle ORM](https://orm.drizzle.team/) via the `@polpo-ai/drizzle` package, sharing the same store interface. Switching between them is a one-line config change.
