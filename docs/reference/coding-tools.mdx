...
Polpo gives agents 9 built-in core tools to interact with the workspace (including HTTP), plus 5 extended tool categories (browser, email, vault, image, and video).
