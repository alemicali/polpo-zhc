...
title: "Email Tools"
sidebarTitle: "Email"
description: "7 tools to send, draft, read, search, and download email attachments via SMTP and IMAP"
---

Send, draft, read, search emails, and download attachments. Enable by including `"email_*"` in the agent's `allowedTools` array.
