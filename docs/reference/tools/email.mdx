...
title: "Email Tools"
sidebarTitle: "Email"
description: "6 tools to send, draft, read, and search email via SMTP and IMAP"
---

Send, draft, read, and search emails. Enable by including `"email_*"` in the agent's `allowedTools` array.
