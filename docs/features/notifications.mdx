...
<CardGroup cols={2}>
  ...
  <Card title="WhatsApp" icon="whatsapp" iconType="brands" href="/notifications/whatsapp">
    Personal WhatsApp via Baileys — text notifications and interactive gateway
  </Card>
...
<Frame>
  <img src="/notification-scopes.svg" alt="Notification rule scope hierarchy: global → mission-level → task-level" />
</Frame>
