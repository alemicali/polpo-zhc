...
See [Playbooks](/features/playbooks) for details on the playbook system.
...
| Command | Description |
|---------|-------------|
| `/memory` | View shared memory. `/memory edit` opens editor. `/memory agent:<name>` for agent memory. |
