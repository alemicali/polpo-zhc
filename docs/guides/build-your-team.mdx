...
4. **Email** — SMTP and IMAP vault configuration.
   ...
   Enabling email gives the agent 8 tools: `email_send`, `email_draft`, `email_verify`, `email_list`, `email_read`, `email_search`, `email_count`, `email_download_attachment`. See [Email Tools](/reference/tools/email).
