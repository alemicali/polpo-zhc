...
See [Expectation Judge](/advanced/expectation-judge/) for details on auto-correction.
...
3. **Escalation** — Switch to a different agent or model if configured

See [Retry & Escalation](/advanced/retry-escalation/) for complete details on the retry flow and escalation policies.
