...
![Detached runner communication flow: orchestrator writes config, spawns runner, runner initializes agent, writes results to RunStore](../../../assets/detached-runners.svg)
...
![Recovery flow: orchestrator restarts, reads RunStore, checks PIDs — alive processes keep running, dead processes get retried](../../../assets/recovery-flow.svg)
