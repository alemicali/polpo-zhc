...
2. **Core** — the supervisor loop, task registry, plan executor, system context (`.polpo/system-context.md`), project memory, and all the managers (assessment, approvals, escalation, scheduling, etc.)
