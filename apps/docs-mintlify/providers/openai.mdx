...
|-------|----------|---------|-----------|
| `gpt-4o` | Multimodal flagship — text, vision, audio | 128K | No |
| `gpt-4.1` | Latest GPT iteration, improved instruction following | 1M | No |
...
| Streaming | Yes |
| Tool use | Yes |
| Vision (images) | Yes (GPT-4o, GPT-4.1) |
| Reasoning | Yes (o3, o4-mini) |
...
- o3 is the strongest reasoning model from OpenAI — consider it for reviewer agents and complex planning tasks.
