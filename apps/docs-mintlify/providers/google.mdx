...
|-------|----------|---------|-----------|
| `gemini-2.5-pro` | Complex reasoning, large codebases | 1M+ | Yes |
| `gemini-2.5-flash` | Fast and cheap, good quality | 1M+ | Yes |
| `gemini-2.0-flash` | Previous generation, very fast | 1M | No |
