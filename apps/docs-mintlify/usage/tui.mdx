...
| Command | Description |
|---------|-------------|
| `/template` | Browse available templates via interactive picker |
| `/template list` | Show a summary of all available templates |
| `/template <name> [key=value ...]` | Execute a template with parameters |
...
See [Templates](/features/templates) for details on the template system.
