...
1. **Fork the repo**
   ...
   Fork [openpolpo/openpolpo](https://github.com/openpolpo/openpolpo) to your GitHub account.
...
3. **Set environment variables**
   ...
   Add any other provider keys you need. The default model requires no key.
...
2. Enter `ghcr.io/openpolpo/openpolpo:latest`
