...
curl -X POST http://localhost:3890/api/v1/projects/my-project/tasks \
...
curl -X POST http://localhost:3890/api/v1/projects/my-project/plans \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Release v2.0",
    "data": "...",
...
```bash
curl -X POST http://localhost:3890/api/v1/projects/my-project/notifications/send \
  -H "Content-Type: application/json" \
  -d '{
