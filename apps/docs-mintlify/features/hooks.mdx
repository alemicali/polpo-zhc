...
Polpo has **15 hook points** that let you intercept, modify, or observe every stage of the workflow lifecycle. Hooks are the primary extension mechanism — use them to add custom validation, logging, notifications, SLA enforcement, and more.
