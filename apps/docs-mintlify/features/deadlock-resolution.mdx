...
<Frame>
  <img src="/deadlock-chain.svg" alt="Deadlock chain: Task A failed ← Task B pending (blocked) ← Task C pending (blocked)" />
</Frame>
...
On every tick (5s), the orchestrator scans for deadlocks:
