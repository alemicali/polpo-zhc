...
Polpo gives agents 7 built-in coding tools to interact with the codebase, plus 11 extended tool categories with 55 additional tools.
...
| [Email](/reference/tools/email) | 5 | `enableEmail` | Send emails via SMTP, read via IMAP |
